      ...
      <div
        ...
        className={twMerge(
          ...
          isDragging
            ...
            : "border-light-300 bg-white hover:border-brand-400 hover:bg-brand-50/10 dark:border-dark-400 dark:bg-dark-200/50 dark:hover:border-brand-400",
      ...
      >
        <div className="flex flex-col items-center justify-center space-y-4 px-6 text-center">
          <div className={twMerge(
            "flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 text-brand-600 shadow-sm transition-all duration-300 group-hover:scale-110 group-hover:bg-brand-100 dark:bg-brand-900/20 dark:text-brand-400",
            isDragging && "scale-110 bg-brand-100"
          )}>
        ...
        {uploading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center rounded-2xl bg-white/90 backdrop-blur-[2px] dark:bg-dark-50/90 p-6 z-20">
            <div className="w-full max-w-[180px] space-y-3">
              ...
              <div className="h-1.5 w-full overflow-hidden rounded-full bg-light-100 dark:bg-dark-200">
                <div 
                  className="h-full bg-brand-500 transition-all duration-300 dark:bg-brand-400"
      ...
      {!hideChecklistButton && (
        <div className="mt-4 flex flex-col gap-2">
          <Button
            ...
            iconLeft={<HiCheckBadge className="h-4 w-4 text-brand-500" />}
